...
<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/Vijay.jpeg" alt="Photo" width="250px" height="200px"></img><br>
<p><a style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font size="5">Vijayaboopathi E</span></a>.</p>
</div>
...
<p><a style="background-color:white;height:25px;width:90%;"> <span style="color:black"><font size="5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+917339454344<br></span></a>.<a style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font size="5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+916381202169</span></a>.</p>
</div>

<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img  src="Image/Email.png" alt="Photo" width="100px" height="80px" style="align:left"></img>
 <p><a style="background-color:white;height:30px;width:100%;" href="mailto:darshanrajappan@gmail.com"> <span style="color:black"><font size="5">Darshan Rajappan</span></a></font></span></a>.<a style="background-color:white;height:30px;width:100%;" href="mailto:vjbp0705@gmail.com"> <span style="color:black"><font size="5"><br>Vijayaboopathi E</span></a></font></span></p>
</div>


<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/Linkedin.png" alt="Photo" width="150px" height="80px"></img><br>
<p><a style="background-color:white;height:30px;width:100%;" href="https://www.linkedin.com/in/darshanrajappan"> <span style="color:black"><font size="5">Darshan Rajappan</span><a style="background-color:white;height:30px;width:100%;" href="https://www.linkedin.com/in/vijayaboopathi"> <span style="color:black"><font size="5"><br>Vijayaboopathi E</span></a></p>
</div>

<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/Photo.jpg" alt="Photo" width="250px" height="200px"></img><br>
<p><a style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font size="5">Darshan R</span></a>.</p>
</div>
<br><br>
